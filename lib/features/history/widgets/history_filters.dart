...
class HistoryFilters extends StatelessWidget {
  ...
  static const List<String> _filters = ['Todos', 'Reportes', 'Actualizaciones', 'Resueltos'];
  static const List<String> _categories = ['Todas', 'Baches', 'Derrumbes', 'Inundaciones'];
  static const List<String> _dates = ['Hoy', 'Esta semana', 'Este mes', 'Este año'];
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: OutlinedButton(
                    ...
                    child: Text(date, style: TextStyle(fontSize: resp.sp(12))),
                  ),
                );
              },
            ),
